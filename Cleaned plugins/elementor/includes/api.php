...
class Api {
	...
	public static function get_upgrade_notice() {
		// Disabled in the cleaned build to avoid remote marketing/update notices.
		return false;
	...
	public static function get_admin_notice() {
		// Disabled in the cleaned build to avoid remote marketing/admin notices.
		return false;
	...
	public static function get_promotion_widgets() {
		// Disabled in the cleaned build to avoid remote promotion widgets.
		return [];
	...
	public static function get_deactivation_data() {
		// Disabled in the cleaned build: no remote deactivation ping.
		return false;
	...
	public static function get_uninstalled_data() {
		// Disabled in the cleaned build: no remote uninstall ping.
		return false;
	...
	public static function send_feedback( $feedback_key, $feedback_text ) {
		// Disabled in the cleaned build: no deactivation feedback is sent remotely.
		return false;
