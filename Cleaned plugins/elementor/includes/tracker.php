...
class Tracker {
	...
	public static function send_tracking_data( $override = false ) {
		// Disabled in the cleaned build: do not send usage tracking data.
		return;
	...
	public static function set_opt_in( $value ) {
		// Cleaned build: keep usage tracking disabled even if the opt-in URL is triggered.
