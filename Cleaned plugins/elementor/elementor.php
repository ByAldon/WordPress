 ...
 * Version: 4.1.3.1
 * Update URI: https://byaldon.local/locked/elementor
...
define( 'ELEMENTOR_VERSION', '4.1.3.1' );
...
$elementor_cleaned_hooks_file = ELEMENTOR_PATH . 'includes/byaldon-cleanup.php';
if ( file_exists( $elementor_cleaned_hooks_file ) ) {
	require_once $elementor_cleaned_hooks_file;
}

if ( ! defined( 'ELEMENTOR_EDITOR_EVENTS_MIXPANEL_TOKEN' ) ) {
	// Disabled in the cleaned build to prevent editor event telemetry.
