...
function fileorganizer_page_footer($no_twitter = 0){
	...
	<div class="fileorganizer_footer_wrap">
		<a href="https://fileorganizer.net" target="_blank" rel="noopener noreferrer">'.esc_html__('FileOrganizer').'</a><span> v'.esc_html(FILEORGANIZER_VERSION).' You can report any bugs </span><a href="https://wordpress.org/support/plugin/fileorganizer" target="_blank" rel="noopener noreferrer">here</a>.
	</div>';
...
function fileorganizer_render_page(){
	...
	$elfinder_config = 'url: fileorganizer_ajaxurl,
		...
		defaultView: "'.esc_js(fileorganizer_sanitize_default_view(!empty($fileorganizer->options['default_view']) ? $fileorganizer->options['default_view'] : 'list')).'",
		height: 500,
