...
class wfConfig {
	...
	public static $defaultConfig = array(
		...
		"checkboxes" => array(
			...
			"notification_promotions" => array('value' => false, 'autoload' => self::AUTOLOAD),
			"notification_blogHighlights" => array('value' => false, 'autoload' => self::AUTOLOAD),
			"notification_productUpdates" => array('value' => false, 'autoload' => self::AUTOLOAD),
	...
	public static function autoUpdate(){
		// Disabled in this cleaned/update-locked custom build to prevent silent plugin replacement.
		// This does not affect firewall rule or malware signature updates.
		return;
