...
class wfNotification implements JsonSerializable {
	...
	public static function reconcileNotificationsWithOptions() {
		...
		$notification_promotions = wfConfig::get('notification_promotions');
		$notification_blogHighlights = wfConfig::get('notification_blogHighlights');
		$notification_productUpdates = wfConfig::get('notification_productUpdates');
