...
== ByAldon Custom Build Notice ==

This cleaned custom build disables promotional/remote marketing output, improves sanitization and escaping, and adds update-lock protection to help prevent the modified version from being overwritten by WordPress.org or automatic plugin updates.
