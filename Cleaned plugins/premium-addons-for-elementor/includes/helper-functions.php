...
class Helper_Functions {
	...
	public static function get_campaign_link( $link, $source, $medium, $campaign = '' ) {
		...
		// ByAldon custom hardening: keep outbound URLs plain; do not append tracking parameters.
	...
	public static function register_papro_promotion_controls( $element, $keyword ) {
		...
		// ByAldon custom hardening: editor upsell notice disabled.
		return;
	}
	...
	public static function register_element_feedback_controls( $element ) {
		...
		// ByAldon custom hardening: element feedback control disabled.
		return;
	}
