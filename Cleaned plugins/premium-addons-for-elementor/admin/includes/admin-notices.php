...
class Admin_Notices {
	...
	public function __construct() {
		...
		// ByAldon custom hardening: remote dashboard story widget disabled.
	}
	...
	public function admin_notices() {
		...
		// ByAldon custom hardening: review/promotional admin notices disabled.
	...
	public function get_review_text( $review_url, $optout_url ) {
		...
		$notice = sprintf(
            ...
            <div>
                <a class="button pa-review-btn button-primary" href="%s" target="_blank" rel="noopener noreferrer"><span>' . __( 'Sure, leave a Review', 'premium-addons-for-elementor' ) . '</span></a>
		...
		<div class="error pa-notice-wrap pa-new-feature-notice">
			...
			<div class="pa-text-wrap">
				<p>
					...
					<?php printf( __( 'has been rebuilt. <a href="%s" target="_blank" rel="noopener noreferrer">Check it out now!</a>', 'premium-addons-for-elementor' ), $link ); ?>
				</p>
			</div>
	...
	public function check_status( $key ) {
		...
		// ByAldon custom hardening: remote license status checks for promo widgets disabled.
		return false;
	}
	...
	public function get_pa_stories() {
		...
		// ByAldon custom hardening: remote dashboard stories disabled.
		return false;
	}
		...
		?>
				...
				<?php foreach ( $stories['banners'] as $index => $banner ) : ?>
					...
					<?php if ( isset( $banner['end'] ) && $time < $banner['end'] ) : ?>
						...
						<div class="pa-stories-banner">
							...
							<a href="<?php echo esc_url( Helper_Functions::get_campaign_link( $banner['link'], 'wp-dash', 'dash-widget', 'summer26' ) ); ?>" target="_blank" rel="noopener noreferrer" title="<?php echo esc_attr( $banner['description'] ); ?>"></a>
						</div>
			...
			<div class="pa-posts-grid">
				...
				<?php foreach ( $stories['posts'] as $index => $post ) : ?>
					...
					<div class="pa-news-post">
						<a style="<?php echo 0 === $index && $highlight ? 'color: #93003f' : ''; ?>" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url( $post['link'] ); ?>">
			...
			<div class="pa-dashboard-widget-block">
				<div class="pa-footer-bar">
					<a href="https://wordpress.org/support/plugin/premium-addons-for-elementor/" target="_blank" rel="noopener noreferrer" style="color: #27ae60">
						Need Help?
						<span aria-hidden="true" class="dashicons dashicons-external"></span>
					</a>
					<a href="https://www.youtube.com/leap13" target="_blank" rel="noopener noreferrer" style="color: #e1002d">
						YouTube Channel
						<span aria-hidden="true" class="dashicons dashicons-youtube"></span>
					</a>
					<a href="https://www.facebook.com/groups/PremiumAddons" target="_blank" rel="noopener noreferrer" style="color: #1877F2;">
						Facebook Community
