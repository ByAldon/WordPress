...
class Feedback {
	...
	public static function send() {
		...
		wp_send_json_error( array( 'message' => __( 'Deactivation feedback is disabled in this cleaned build.', 'premium-addons-for-elementor' ) ) );
	}
						...
						<section class="messages-wrap" data-feedback>
							...
							<p class="options-wrap pa-info-notice">
								...
								echo __( 'Having speed issues or Elementor editor not loading? Your website PHP limits might be the reason. Here\'s ', 'premium-addons-for-elementor' ) .
										sprintf( '<a target="_blank" rel="noopener noreferrer" href="%s">%s</a>', $link, __( 'how to increase the PHP limits', 'premium-addons-for-elementor' ) );
								?>
							</p>
