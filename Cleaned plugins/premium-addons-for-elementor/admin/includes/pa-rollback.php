...
class PA_Rollback {
	...
	public function run() {
		...
		wp_die( esc_html__( 'Rollback is disabled in this cleaned update-locked build. Upload a reviewed ZIP manually if you want to replace it.', 'premium-addons-for-elementor' ) );
