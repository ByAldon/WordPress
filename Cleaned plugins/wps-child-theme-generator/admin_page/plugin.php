...
if ( ! current_user_can( 'manage_options' ) ) {
	wp_die( esc_html__( 'You do not have permission to access this page.', 'wps-child-theme-generator' ) );
}
?>
    ...
    <div class="wps-generator-content">
        <div class="wps-tab">
            ...
            if ( isset( $_POST['submit'] ) ) {
                echo wp_kses_post( \WPS\WPS_Child_Theme_Generator\Helpers::create_child_theme() );
            } ?>
            <form action="" method="post">
                ...
                <p>
                    ...
                    <span class="wps_col_two">
                        <input type="text" name="b7ectg_author" size="30" id="b7ectg_author" value="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
                    </span>
                </p>
                <p>
                    <span class="wps_col_one">
                ...
                <div id="thumb_info_0" style="">
                    ...
                    <span class="wps_col_two">
                        ...
                        <button id="upload-button" class="upload-custom-img button btn-wps btn-wps-screenshot"><?php _e( 'Add screenshot', 'wps-child-theme-generator' ); ?></button> <i><?php _e('Screenshot can be no larger than 1200x900px, recommended 600x450px', 'wps-child-theme-generator');?></i>
...
-->
                ...
                <p>
                    ...
                    <code><?php _e( 'Search results URL will be /search/query instead of ?s=query. You may need to save your permalinks after theme activation.', 'wps-child-theme-generator' ); ?></code>
                    </label>
                </p>
