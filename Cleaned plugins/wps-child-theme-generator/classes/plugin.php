...
class Plugin {
    ...
    public static function plugin_action_links( $links ) {
        array_unshift( $links, '<a href="' . admin_url( 'tools.php?page=wps-child-theme-generator' ) . '">' . esc_html__( 'Tools', 'wps-child-theme-generator' ) . '</a>' );
    ...
    public static function tool_box() { ?>
        <div class="card">
            ...
            <p><?php printf( __( 'Don\'t know where to start with your child theme, use the <a href="%s">WPS Child Theme Generator</a>.' ), admin_url( 'tools.php?page=wps-child-theme-generator' ) ); ?></p>
        </div>
        <?php
    }
